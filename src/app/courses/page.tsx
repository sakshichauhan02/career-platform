...
function enrichCourse(c: any): EnhancedCourse {
  ...
  if (tags.includes('Technology')) {
    [
      ...
      'security',
      'networks',
    ].forEach((s) => semanticKeywordsSet.add(s));
  }
...
export default function CoursesCatalogPage() {
  ...
  const filteredCourses = courses.filter((c) => {
    // 1. Category Filter
    const matchesCategory = selectedCategory === 'All' || c.tags.includes(selectedCategory);
    ...
    const matchesDuration =
      selectedDuration === 'All' || c.durationYears.toString() === selectedDuration;
        ...
        <div className="mx-auto max-w-7xl space-y-8">
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <p className="text-sm font-medium text-slate-500">
              ...
              exams, and college options. Support for advanced filtering, semantic-keyword search,
              and 500+ records.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="border-border focus:border-primary focus:ring-primary/20 w-full rounded-xl border bg-white py-3 pr-4 pl-11 text-xs text-slate-950 placeholder-slate-400 transition-all outline-none focus:ring-2"
                />
              </div>
              ...
              <Button
                ...
                className={`flex items-center gap-1.5 rounded-xl border px-4 py-3 text-xs font-bold shadow-sm transition-all ${
                  showFilters
            ...
            <div className="no-scrollbar -mx-4 flex gap-2 overflow-x-auto px-4 py-1 md:mx-0 md:px-0">
              {categories.map((cat) => (
                <button
                  ...
                  className={`shrink-0 rounded-full border px-4 py-1.5 text-xs font-semibold shadow-sm transition-all ${
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {currentCourses.length === 0 ? (
                  <div className="border-border text-slate-550 col-span-full rounded-3xl border bg-white p-12 text-center shadow-sm">
                    No courses found matching your active filters. Try resetting search query or
                    filters.
                  </div>
                ) : (
                    ...
                    >
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <span className="bg-primary/5 text-primary inline-flex items-center gap-1 rounded px-2.5 py-1 text-[10px] font-bold">
