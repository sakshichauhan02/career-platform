...
async function seedLocalFile() {
  ...
  const coursesTS = formattedCourses.map(c => {
    return `  {\n` +
      `    id: '${c.id}',\n` +
  ...
  try {
    ...
    console.log(`Success! Appended ${formattedCourses.length} highly realistic, fully detailed courses to PREDEFINED_COURSES in recommendationEngine.ts.`);
